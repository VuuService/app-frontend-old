<template>
  <li>
    <input id="published" v-model="checked" class="hidden" name="status" type="checkbox" />
    <label class="flex items-center space-x-4 cursor-pointer py-3 sm:py-4 px-4" for="published">
